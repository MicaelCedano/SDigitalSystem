...
export function GarantiasDashboardClient({
    ...
    return (
        <div className="space-y-8 animate-in fade-in duration-700 slide-in-from-bottom-4">
            ...
            {/* Técnico Balances section for Admin */}
            {currentUser.role === 'admin' && (
                <div className="bg-white rounded-[2.5rem] border border-slate-100 shadow-xl overflow-hidden mt-8">
                    <div className="px-8 py-6 border-b border-slate-100 bg-slate-50/50 flex items-center justify-between">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                <h3 className="text-xl font-black text-slate-800">Balances de Técnicos</h3>
                                <p className="text-xs font-medium text-slate-400 tracking-wider">Gestión de pagos por reparaciones</p>
                            </div>
                        </div>
                        <Button variant="outline" className="rounded-xl border-emerald-100 text-emerald-600 hover:bg-emerald-50 h-10 gap-2">
                            <DollarSign className="w-4 h-4" /> Ajustes Masivos
                        </Button>
                    </div>
